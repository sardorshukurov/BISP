...
public static class ObjectJsonExtension
{
    ...
    /// </summary>
    public static T? FromJsonString<T>(this string obj, JsonSerializerSettings? settings)
    {
    ...
    /// Deserialize object from JSON string
    /// </summary>
    public static object? FromJsonString(this string obj, JsonSerializerSettings? settings)
    {
