...
namespace Welisten.Context.Migrations.PgSql.Migrations
{
    ...
    [Migration("20240426151514_UpdateArticlesIdPK")]
    partial class UpdateArticlesIdPK
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Welisten.Context.Entities.Articles.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Welisten.Context.Entities.Articles.ArticleCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Welisten.Context.Entities.Articles.Article", b =>
                {
                    b.HasOne("Welisten.Context.Entities.Articles.ArticleCategory", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Welisten.Context.Entities.MoodRecord", b =>
                {
                    b.HasOne("Welisten.Context.Entities.EventType", "Event")
                        .WithMany()
